...
char *floatToString2(char *outstr, float value, int places, int minwidth,
                     bool rightjustify);
...
void requestEvent() {
  ...
  if (stateRequest == 0) {
    ...
    Wire.write(floatToString2(stringBuffer, CO2ppm, precision,
                              sizeOfNumberInString, false));
    Wire.write(',');
    Wire.write(floatToString2(stringBuffer, O2ppm, precision,
                              sizeOfNumberInString, false));
